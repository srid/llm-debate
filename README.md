...
- **[PCE, pure intent & rememoration — and how to practise](debates/pce-pure-intent-rememoration/)** — a different question: what these actualism terms mean, and how someone who *remembers* their PCEs puts them into practice. Five adversarial, fully-sourced turns (every claim a verbatim quote, author-labelled R/Richard or P/Peter), with an [SVG of the practice chain](debates/pce-pure-intent-rememoration/concepts.svg) and a [ratified ledger](debates/pce-pure-intent-rememoration/conclusion.md).
